...
msg_phone_error = 'Возможно, Вы ввели некорректный номер телефона, пожалуйста, введите телефонный номер в формате 89991234567 или нажмите кнопку ниже'
...
msg_error_order = 'Заказ не был оформлен, т.к. в корзине ничего нет. Чтобы оформить заказ, выберите товар и положите его в козину'
