...
msg_start = '''Это сообщение, к которому крепится главное меню. Оно обязательно должно быть. Возможно, приветствие, или призыв к действию. Если его убрать, главное меню пропадёт'''
